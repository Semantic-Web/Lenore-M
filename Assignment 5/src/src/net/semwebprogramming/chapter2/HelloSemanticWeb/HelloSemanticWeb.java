...
package src.net.semwebprogramming.chapter2.HelloSemanticWeb;
...
public class HelloSemanticWeb {
	...
	//This is a failed attempt to determine how to do this.
	private void applySelfRule(InfModel model) {
